...
```{bash}
$ /usr/local/share/jupyterhub/env/R/lib/R/bin/R CMD BATCH analyze-1.R
```

- Create a new text file named **analyze-2.R** inside **intro-to-r**

```{r analyze-2, write_chunk=TRUE}
...
```{bash}
$ /usr/local/share/jupyterhub/env/R/lib/R/bin/Rscript analyze-2.R /home/lngo/intro-to-r/ data/combined.csv years_sex_counts-3.png
```

- Create a new text file named **analyze-3.R**

```{r analyze-3, write_chunk=TRUE}
...
rm output_graph/*
./analyze-3.R /home/lngo/intro-to-r/ data/combined.csv years_sex_counts-pbs.png
```
