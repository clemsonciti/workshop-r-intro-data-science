...
```{r}
surveys <- read.csv("data/combined.csv", header = TRUE)
head(surveys)
```
...
- Data frames are the *de facto* data structure for R's tabular data, and conceptionally equivalent to an Excel spreadsheet (albeut much more powerful)
